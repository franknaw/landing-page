...
LABEL version="0.0.1"
LABEL description="Simple Landing Page"
...
COPY go.sum /myapp
COPY *.go /myapp
COPY templates/index.tmpl /myapp/templates/index.tmpl
...
RUN GOOS=linux GOARCH=amd64 go build -o /landing-page -ldflags="-s -w"
